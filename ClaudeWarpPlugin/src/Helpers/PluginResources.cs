namespace Loupedeck.ClaudeWarpPlugin
{
    ...
    internal static class PluginResources
    {
        ...
        // The parameter `folderName` must be specified as a full path, for example, `Loupedeck.ClaudeWarpPlugin.Resources`.
        // Returns the full names of the resource files, for example, `Loupedeck.ClaudeWarpPlugin.Resources.Resource.txt`.
